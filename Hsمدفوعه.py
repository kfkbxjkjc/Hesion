...
expiry_time = datetime.strptime('''2024-3-24 00:00:00.000''', '''%Y-%m-%d %H:%M:%S.%f''')
...
# re = requests.get("https://pastebin.com/raw/vzSiuq8W")

# print ("\033[1;92m تسـجيل دخول نمࢪود")
# print ("\033[1;97m ") 
# password = input('          \033[1;93m ڪلمة السر حياتي: ') 
print
...
def chk():
  ...
  try: 
    ...
    if "" == "":
      ...
      SDMi("\033[0;96mعزيزي راسل مبرمج نمࢪود للاشتراك في ادواتي لـVIP @Y_W_R_O") 
...
print('\n')
ID=input('  \x1b[38;5;117m{\x1b[1;32m𓅇 \x1b[38;5;199m}  I̙͓̞D̪͕͚ \x1b[1;38;5;117m જ⁀➴  \x1b[38;5;130m︎')
os.system('clear')
...
def menu():	
	...
	print('» 2- 𝒄𝒓𝒂𝒄𝒌 𝒇𝒊𝒍𝒆  : مــن مــلــف  ') 
...
def crack(idf, pwv):
	...
	sys.stdout.write(f"\r{bo}({amr}𖤤ذا مو مدفوع مرجوع 𖤤) {loop}•{len(id)}  • OK:{ok} •  CP:{cp} • ({'{:.0%}'.format(loop/float(len(id)))}{amr})"),
	sys.stdout.flush()
